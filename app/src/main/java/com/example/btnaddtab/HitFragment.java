...
//                        }
                ...
                getActivity().runOnUiThread(() -> {
                    recyclerView = getView().findViewById(R.id.recyclerView_hit);
                    recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
                    recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL));
                    recyclerView.setAdapter(new HitAdapter(getActivity(), arrayList));
                    dialog.dismiss();
                });
            }
        });
...
//                iv_thumbnail = itemsView.findViewById(R.id.img_thumbnail);
        ...
        public HitFragment.HitAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new HitFragment.HitAdapter.viewHolder(itemView);
        }
